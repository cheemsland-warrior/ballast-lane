...
After that you can run the angular project and register an account, log in add a pothole and see the list of potholes. Pothole list is public and does not need login but creating is guarded under
